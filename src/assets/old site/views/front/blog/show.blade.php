        ...
        <section id="post-title"
            ...
            <div class="container text-white fw-bold text-center my-5 py-5 position-relative">
                ...
                <div class="d-flex align-items-center justify-content-center gap-1">
                    ...
                    <span>/</span>
                    <span class="text-white-50">{{read_lang_word('هدر-صفحات-داخلی','blog2')}}</span>
                </div>
            </div>
        </section>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-4">
                            <div class="mb-4">
                                <a  href="{{route('front.blog.show',[$item->type,$item->id])}}" class="d-block h4 cursor text-decoration-none transition fw-bold"> {{read_lang($item , 'title') }}</a>
                                <span class="primary-color fw-bold h5">{{Carbon\Carbon::parse($item->created_at)->toFormattedDateString()}}</span>
                            </div>
                        
                        </div>
                        @endforeach
                       
                         @include('front.includes.follow',['contact'=> $contact])
                    </div>
                </div>
            </div>
        </section>
