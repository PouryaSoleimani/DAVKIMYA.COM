    ...
    <main>
        ...
        <section id="project-title"
            ...
            <div class="container text-white fw-bold text-center my-5 py-5 position-relative">
                ...
                <div class="d-flex align-items-center justify-content-center gap-1">
                    <a href="index.html" class="d-block primary-color fw-bold text-decoration-none">{{read_lang_word('منو','1')}}</a>
                    <span>/</span>
                    <span class="text-white-50">{{read_lang_word('زیر-منو','4')}}</span>
                </div>
            </div>
        </section>
        ...
        <section id="single-service" class="container my-5 left">
            <div class="row g-4">
                <div class="col-lg-8">
                    <div>
                        <img alt="{{$item->title}}" src="{{$item->photo && is_file($item->photo->path)?url($item->photo->path):url('assets/front/img/home1/blog-1.jpg')}}"
                            class="img-fluid">
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mt-5">
                        <h2 class="fw-bold"> {{read_lang_word('هدر-صفحات-داخلی','project2')}}</h2>
                        @foreach($items_last as $item)
                        <div>
                            <a  href="{{route('front.project.show',[$item->id])}}"
