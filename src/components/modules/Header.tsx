                    ...
                    <div className="container-fluid bg-[#474841] ">
                        ...
                        <div className={`${showMenu === false ? "collapse" : ""} navbar-collapse translate-y-2 lg:translate-y-3`}>
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 gap-4 ">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link primary-color" href="https://pouryasoleimani-adddesign.storage.c2.liara.space/DAV___KIMYA/DAV%20catalog.pdf" target="_blank">{t("Online Catalogue")}</Link>
                                </li>
                            </ul>
                            {/* <!-- SEARCH MODAL --> */}
