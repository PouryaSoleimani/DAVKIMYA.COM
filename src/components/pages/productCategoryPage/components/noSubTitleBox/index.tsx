...
import t1s2 from "@/../public/images/products__page/emulationSystem.webp";
...
import t12s2 from "@/../public/images/products__page/poly.webp";
...
const NoSubTitleBox = ({ mainTitle, title, src }: NoSubTitleBoxProps) => {
  ...
  const imagesArr = [t1s1, t1s2, t1s3, t1s4,t2s1,t12s2,t2s3,t2s4,t2s5,t2s6,t4s1,t4s2,t4s3];
